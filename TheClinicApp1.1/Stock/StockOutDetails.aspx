    ...
    <div class="main_body">
        ...
        <div class="left_part">
          ...
          <ul class="menu">
              ...
              <li id="admin" runat="server" style="visibility:hidden"><a name="hello" onclick="selectTile('admin','<%=RoleName %>')"><span class="icon registration"></span><span class="text">Admin</span></a></li>
            </ul>
