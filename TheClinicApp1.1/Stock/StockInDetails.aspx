...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script src="../js/vendor/modernizr-2.6.2-respond-1.1.0.min.js"></script>
      ...
      <div class="tab-content">
        ...
        <div class="grey_sec">
         ...
         <ul class="top_right_links"><li><a class="back" href="StockIn.aspx"><span></span>Back</a></li><li><a class="save" id="btSave" runat="server" onserverclick="btSave_ServerClick" href="#"><span></span>Save</a></li><li><a class="new" href="#"><span></span>New</a></li></ul>
         </div>
  ...
  <tr>
     <td ><input id="txtMedName" type="text" placeholder="Medicine" class="input"/></td>
      ...
      <td><input id="txtMedQty" type="text" placeholder="Quantity" class="input"/></td><td style="background-color:transparent">
    <input type="button" value="-" class="bt1" style="width:20px;"/></td><td style="background-color:transparent">
