    ...
    <div class="main_body">
        ...
        <div class="left_part">
            ...
            <ul class="menu">
                ...
                <li id="master" runat="server" visible="false"s><a name="hello" onclick="selectTile('<%=master.ClientID %>','')"><span class="icon master"></span><span class="text">Master</span></a></li>
