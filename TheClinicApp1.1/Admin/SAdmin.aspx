...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="main_body">
        ...
        <div class="right_part" style="background-color: white;">
            <div class="tagline">
                <a class="nav_menu">Menu</a>Create Group and Clinics<ul class="top_right_links">
                    <li>
            ...
            <div class="icon_box">
                <a class="all_assignrole_link" data-toggle="modal" data-target="#AllClinics" onclick="OpenModal();">
                    <span class="tooltip1">
                        <span class="count" style="background: #bb33d4;">
                            <asp:Label ID="lblClinicCount" runat="server" Text="0"></asp:Label>
                        </span>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div style="margin-bottom: 1%" id="DivMultiRoles">
                                        ...
                                        <asp:ListBox ID="lstFruits" runat="server" SelectionMode="Multiple">
                                            ...
                                            <asp:ListItem Text="Stock" Value="5"></asp:ListItem>
                                            <asp:ListItem Text="Report" Value="6"></asp:ListItem>
                                        </asp:ListBox>
                                    </div>

                                    <div style="margin-bottom: 1%">
                                        <label>Select Required Reports</label>
                                        <asp:ListBox ID="lstRequiredReports" runat="server" SelectionMode="Multiple">
                                            <asp:ListItem Text="Stock" Value="1000" />
                                            <asp:ListItem Text="All Registered Patients" Value="1001" />
                                            <asp:ListItem Text="Out Of Stock" Value="1002" />
    ...
    <script>
        ...
        function showpreview(input) {
            ...
            if (input.files && input.files[0]) {
             ...
             $(function () {
                 $('[id*=lstRequiredReports]').multiselect({
                     includeSelectAllOption: true
                 });
             });
    ...
    $(function () {
        ...
        $("[id*=dtgViewAllClinics] td:eq(0)").click(function () {
            ...
            var jsonReportList = GetReportListOfClinic();

            if (jsonReportList != undefined) {
                BindRequiredRoleList(jsonReportList)
            }
    ...
    function GetReportListOfClinic() {
        var Master = new Object();
        Master.ClinicID = $("#<%=hdnClinicID.ClientID %>").val();;

                 var ds = {};
                 var table = {};
                 var data = "{'MasterObj':" + JSON.stringify(Master) + "}";
             ...
             function BindRequiredRoleList(Records) {
