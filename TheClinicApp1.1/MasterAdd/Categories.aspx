    ...
    <div class="main_body">
        ...
        <div class="left_part">
            ...
            <ul class="menu">
                ...
                <li id="log" runat="server"  ClientIDMode="Static"><a name="hello" id="Logout" runat="server" onserverclick="Logout_ServerClick"><span class="icon logout"></span><span class="text">Logout</span></a></li>
            </ul>
