...
namespace TheClinicApp1._1.ClinicDAL
{
    public class Doctor
    {
        ...
        #region Get Regular Schedule OF Doctor
        public DataSet GetRegularScheduleOFDoctor()
        {
            if (DoctorID == "")
            {
            ...
            catch (Exception ex)
            {
                ...
                eObj.Module = Module;
                eObj.UserID = UA.UserID;
                eObj.Method = "GetRegularScheduleOFDoctor";
                eObj.InsertError();
            }
            finally
            {
        ...
        #endregion Get Regular Schedule OF Doctor
        ...
        public DataSet GetDoctorScheduleDetailsByDoctorIDforMobile()
        {
            ...
            try
            {
                ...
                cmd.Connection = dcon.SQLCon;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "GetDoctorScheduleDetailsByDoctorIDforMobile";
                cmd.Parameters.Add("@DoctorID", SqlDbType.UniqueIdentifier).Value = Guid.Parse(this.DoctorID);
                cmd.Parameters.Add("@ClinicID", SqlDbType.UniqueIdentifier).Value = Guid.Parse(this.ClinicID);
                //   cmd.Parameters.Add("@MonthName", SqlDbType.NVarChar,30).Value = MonthName;
                sda.SelectCommand = cmd;
        ...
        #endregion GetAllSchedulesByDoctorID
        ...
        #region CancelAllScheduleByDoctor

        public Int16 CancelAllScheduleByDoctor()
        {
            dbConnection dcon = null;
            SqlCommand cmd = null;
            SqlParameter outParameter = null;
            ...
            try
            {
                ...
                cmd.Connection = dcon.SQLCon;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "[CancelAllScheduleByDoctor]";
                cmd.Parameters.Add("@DoctorID", SqlDbType.UniqueIdentifier).Value = Guid.Parse(DoctorID);
                cmd.Parameters.Add("@ClinicID", SqlDbType.UniqueIdentifier).Value = Guid.Parse(ClinicID);
                cmd.Parameters.Add("@Date", SqlDbType.Date).Value = DoctorAvailDate;
                cmd.Parameters.Add("@UpdatedBy", SqlDbType.NVarChar, 255).Value = UpdatedBy;
                cmd.Parameters.Add("@UpdatedDate", SqlDbType.DateTime).Value = DateTime.Now;
                outParameter = cmd.Parameters.Add("@UpdateStatus", SqlDbType.SmallInt);
                outParameter.Direction = ParameterDirection.Output;
            ...
            catch (Exception ex)
            {
                ...
                eObj.Module = Module;
                eObj.UserID = UA.UserID;
                eObj.Method = "CancelAllScheduleByDoctor";
                eObj.InsertError();
            }
            finally
            {
        ...
        #endregion CancelAllScheduleByDoctor

        #region GetDoctorAvailability
        public DataSet GetDoctorAvailability()
        {
            if (ClinicID == "")
            {
                throw new Exception("ClinicID is Empty!!");
            ...
            catch (Exception ex)
            {
                ...
                eObj.Module = Module;
                eObj.UserID = UA.UserID;
                eObj.Method = "GetDoctorAvailability";
                eObj.InsertError();
            }
            finally
            {
